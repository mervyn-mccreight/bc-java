...
public class SRATest extends SimpleTest {
    ...
    private static int CERTAINTY = 80;
    ...
    private void commutativeTest() {
        ...
        try {
            ...
            fail("Error getting proper SecureRandom instance.", e);
        }

        SRAKeyPairGenerator aliceKeyGen = new SRAKeyPairGenerator();

        SRAKeyPairGenerator.SRAKeyGenerationParameters aliceParams = new SRAKeyPairGenerator.SRAKeyGenerationParameters(p, q, random, CERTAINTY);
        ...
        SRAKeyPairGenerator.SRAKeyGenerationParameters bobParams = new SRAKeyPairGenerator.SRAKeyGenerationParameters(p, q, random, CERTAINTY);
